...
render.prototype.init = function() {
  ...
  this.msgH =
    parseInt(
      this.g.theme.font.scoreMsgPoints.replace(/bold +([0-9]+)(px|pt).*/, '$1')
    ) * 1.25;
...
render.prototype.drawAnimationOverlay = function() {
  var now = new Date().getTime();
...
render.prototype.drawSystemMessage = function(msg) {
  this.g.ctx.save();
...
render.prototype.drawLayout = function() {
  var drawOpponent = this.g.width > this.g.defWidth;
  this.g.ctx.save();
  ...
  this.g.ctx.fillRect(this.pStartX, this.pStartY, this.pWidth, this.pHeight);
  if (drawOpponent) {
    this.g.ctx.fillRect(this.oStartX, this.oStartY, this.pWidth, this.pHeight);
  }
  this.g.ctx.restore();
  this.g.ctx.save();
...
render.prototype.drawNextPieces = function() {
  this.ctx.save();
...
render.prototype.drawHoldPiece = function(now) {
  this.ctx.save();
...
render.prototype.drawScore = function(now) {
...
render.prototype.drawLevel = function() {
  this.g.ctx.save();
  var rX = this.mStartX;
  var rW = this.mW;
...
render.prototype.drawTime = function() {
...
render.prototype.drawGrid = function(opponent) {
  var sx = this.pStartX;
  var sy = this.pStartY;
  if (opponent) {
    var sx = this.oStartX;
...
render.prototype.drawFallingPiece = function(opponent) {
...
render.prototype.drawFixedBlocks = function(opponent) {
  var sX = this.pStartX;
  var sY = this.pStartY;
...
render.prototype.drawLoader = function() {
...
render.prototype.drawCountDown = function(now) {
...
render.prototype.drawBlock = function(t, x, y, a, p, s) {
...
render.prototype.drawSpecialEffects = function() {
  this.ctx.save();
...
render.prototype.drawGhost = function() {
...
render.prototype.drawMessages = function() {
  this.ctx.save();
...
render.prototype.getMsgPos = function(msg) {
  var r = msg.r;
  var c = msg.c;
  if (r && c) {
    if (c > 6) {
...
render.prototype.textWidth = function(text, font) {
...
render.prototype.drawLeaderBoard = function() {
  if (this.g.lbIsShowing) {
    ...
    for (var i = 0; i < 25; i++) {
      ...
      if (r) {
        ...
        this.ctx.shadowOffsetX = 2;
        this.ctx.shadowOffsetY = 2;
        this.ctx.fillText(score, x + this.lbScoreX - this.textWidth(score), y);
      }
    }
    this.ctx.restore();
  }
...
render.prototype.drawWave = function() {
  var wavePower = 40;
  var force = 0;
